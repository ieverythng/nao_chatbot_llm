A ollama-based LLM bridge for robotic applications
====================
...
## Compile and install chatbot_llm
...
Check `chatbot_llm/node_impl.py` to see how this is done, and implement your own
techniques.
